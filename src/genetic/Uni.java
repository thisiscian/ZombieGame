...
static float []uni_u = new float[98];	/* Was U(97) in Fortran version -- too lazy to fix */
static float uni_c, uni_cd, uni_cm;
static int uni_ui, uni_uj;
    ...
    private static void rstart(int i, int j, int k, int l)
    {
	int ii, jj, m;
	float s, t;
    ...
    public static void rinit(int ijkl)
    {
	int i, j, k, l, ij, kl;
